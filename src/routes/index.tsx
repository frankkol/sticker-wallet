      ...
      <header className="sticky top-0 z-40 px-3 sm:px-6 pt-3 sm:pt-5">
        <nav className="glass-strong rounded-full shadow-card px-3 sm:px-4 py-2 flex items-center gap-2 sm:gap-4 max-w-6xl mx-auto">
          ...
          <button
            ...
            // className="hidden sm:flex h-9 w-9 rounded-full bg-secondary/40 hover:bg-destructive/30 hover:text-destructive items-center justify-center transition shrink-0"
            className="flex-1 sm:flex h-9 w-9 rounded-full bg-secondary/40 hover:bg-destructive/30 hover:text-destructive items-center justify-center transition shrink-0"
            title="Resetar"
          >
